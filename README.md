Task 1 [PASSWORD GENERATOR] : It contains a password generator program that generates a strong and random password for users, allowing users to specify the length and complexity of the password.
